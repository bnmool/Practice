...
(function (e, d, a, f) {
    ...
    c.prototype = {
        constructor: c, destroy: function () {
            ...
            var k = e("<li></li>"), h = e("<a></a>"), g = this.options[i] ? this.makeText(this.options[i], j) : j;
            ...
            this.$listContainer.children().each(function () {
                var k = e(this), j = k.data("page-type");
                switch (j) {
                    case"page":
            ...
            var h = this.getSearchString(g), i = new RegExp(this.options.pageVariable + "(=([^&#]*)|&|#|$)"),
                j = i.exec(h);
            if (!j || !j[2]) {
                return null
            }
            ...
            var i = this.getSearchString(h), j = new RegExp(this.options.pageVariable + "=*[^&#]*");
            if (!i) {
                return ""
            }
